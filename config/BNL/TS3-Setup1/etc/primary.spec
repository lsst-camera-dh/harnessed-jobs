...
DATE        String  ${ObservationDate}         Creation Date and Time of File
DATE-OBS    String  ${ObservationDate}          Date of the observation (image acquisition), UTC
MJD-OBS     Float   ${ObservationDateMJD}       Modified Julian Date (5 decimal places) of image acquisition
...
FILTPOS     Integer ${ts/filter1position}       Filterposition
EXPTIME     Float   ${ExposureTime}             Exposure Time in Seconds
EXPOSURE    Float   ${ExposureTime}             Exposure Time in Seconds
...
CCDGAIN     Float   3.02                        Rough guess at overall system gain (e-/DNB)
CCDNOISE    Float   6                           Rough guess at system noise (e- rms)
CTLRCFG     String  ${ConfigFile}               Configuration file name
