...
def raftId = Integer.valueOf(System.getProperty("org.lsst.ccs.raft.id","0"));
System.out.println("Building raftId: "+raftId);

def partition = System.getProperty("org.lsst.ccs.raft.partition","")
...
//        GlobalVisualizationClient (GlobalVisualizationClient, clientHost:"lsst-vs01.slac.stanford.edu", clientPort:9999)
	...
	TempCtrl   (TempControl, gain: 0.1, timeConst: 120.0, smoothTime: 20.0,
                maxOutput: 2.0, awGain: 4.0, basePower: 0.0, tolerance: 0.05,
                updateTime: 1000, rebs: ["R00.Reb2", ], tempChans: ["R00.Reb2.CCDTemp1"])
/*
	TempCtrl   (TempControl, gain: 0.1, timeConst: 120.0, smoothTime: 20.0,
                maxOutput: 4.0, awGain: 4.0, basePower: 0.0, tolerance: 0.05,
                updateTime: 1000, rebs: ["R00.Reb0", "R00.Reb2"], tempChans: ["R00.Reb0.CCDTemp1", "R00.Reb1.CCDTemp1", "R00.Reb2.CCDTemp1"])
*/
        ...
        for (Reb rebGeometry : raftGeometry.getChildrenList() ) {
            def rebCount = 220+rebGeometry.getParallelPosition();
