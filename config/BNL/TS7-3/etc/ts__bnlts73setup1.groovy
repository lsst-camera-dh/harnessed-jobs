...
builder.
//    main (TSSubSys, name:"main", tickMillis:10000, configName:"bnlts8") {
    main (TSSubSys, configName:"bnlts6", broadcastMillis:10000) {

//    Bias  (KeithleyDevice, host:"PH", port:57600)

    PhotoDiode  (KeithleyDevice, host:"PJ", port:57600)

//    PhotoDiode  (KeithleySimDevice, host:"PJ", port:57600)
////    Cryo   (CryoCon24cDevice, itype:1, host:"A5060GDR", port:19200)
    Cryo   (CryoCon24cDevice, itype:1, host:"A5060GDS", port:19200)
...
//    PDU (AP7900Device, host:"130.199.47.28", port:23)
